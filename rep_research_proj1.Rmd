...
```{r, echo=FALSE}
hist(tapply(activity$steps,activity$date,sum), main = paste("Total Number of Steps Taken per Day"), xlab="Steps")
```
...
The new mean is `r newMean` . The new median is `r newMedian` . 
